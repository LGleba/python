...
def main():
    ...
    numMinus = Button(text="Minus -", width=12, height=3, font="Arial")
    numMinus.grid(row=5, column=3)
    ...
    def operat1016(event):
        ...
        try:
            ...
            if fg:
                ...
                if s == 0:
                    ...
                    tree.set('item{:}'.format(numberOp), '1', "{:}".format("0"))
                    tree.set('item{:}'.format(numberOp), '2', "{:}".format("10 --> 16"))
                    tree.set('item{:}'.format(numberOp), '3', "{:}".format("0"))
                    numberOp += 1
                    return
        except:
            line.delete(0, END)
        ...
        newChislo = str(newChislo)

        if newChislo[0] == ".":
            newChislo = "0" + newChislo
    ...
    numMinus.bind('<Button-1>', operatminus)
